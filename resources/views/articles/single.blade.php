        ...
        <main class="row content__page">
            ...
            <article class="column large-full entry format-standard">
                    ...
                    <div class="entry__post-thumb">
                        <img src="images/thumbs/single/standard/standard-1000.jpg" 
                             srcset="{{ asset('images/thumbs/single/standard/standard-2000.jpg') }} 2000w, 
                                     ...
                                     {{ asset('images/thumbs/single/standard/standard-500.jpg') }} 500w" sizes="(max-width: 2000px) 100vw, 2000px" alt="">
                    </div>
                </div>
                ...
                <div class="entry__content">
                    ...
                    <p>
                    <img src="{{ asset('images/wheel-1000.jpg') }}" 
                         srcset="{{ asset('images/wheel-2000.jpg') }} 2000w, 
                                 {{ asset('images/wheel-1000.jpg') }} 1000w, 
                    ...
                    <ul class="related">
                        <li class="related__item">
                            <a href="single-standard.html" class="related__link">
                                <img src="{{ asset('images/thumbs/masonry/walk-600.jpg') }}" alt="">
                            </a>
                            <h5 class="related__post-title">Using Repetition and Patterns in Photography.</h5>
                        </li>
                        <li class="related__item">
                            <a href="single-standard.html" class="related__link">
                                <img src="{{ asset('images/thumbs/masonry/dew-600.jpg') }}" alt="">
                            </a>
                            <h5 class="related__post-title">Health Benefits Of Morning Dew.</h5>
                        </li>
                        <li class="related__item">
                            <a href="single-standard.html" class="related__link">
                                <img src="{{ asset('images/thumbs/masonry/rucksack-600.jpg') }}" alt="">
                            </a>
